...
func setupGetByID() ([]string, domain.FreeMarket, sqlmock.Sqlmock, *sqlx.DB) {
	cols := []string{
		"id",
		"latitude",
		"longitude",
...
func TestGetByID(t *testing.T) {
	t.Run("should get a free market by id", func(t *testing.T) {
		cols, freeMarketResponse, mock, database := setupDelete()
		defer database.Close()

		mock.ExpectQuery("SELECT (.+) FROM free_market").WithArgs(
